...
function openModal(i) {{
  ...
  if (t.interactive_file) {{
    ...
    html += `<div class="khelo-top" style="margin-top:14px">
      ...
      <span class="hint">Pehle app (neeche panel), us ke neeche quiz.</span>
  ...
  // Lesson optional at end (Sunlo) — does not sit between app and quiz
  if (t.lesson) {{
    window.__lessonRaw = t.lesson;
    html += `<div class="read-bar" style="margin-top:16px">
