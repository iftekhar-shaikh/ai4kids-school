...
function openModal(i) {{
  ...
  // 2) Khelo (opens under-grid Streamlit panel — cannot run inside this iframe)
  if (t.interactive_file) {{
    ...
    html += `<div class="khelo-top" style="margin-top:14px">
      ...
      <span class="hint">App grid ke NEACHE list se topic dabao (Sabaq+Sunlo → App → Quiz). Iframe ke andar app block hoti hai.</span>
