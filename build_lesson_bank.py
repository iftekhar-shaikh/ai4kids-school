...
.trust{display:flex;flex-wrap:wrap;gap:8px;align-items:center;justify-content:center;padding:10px 12px;margin:12px 16px 0;background:#eafaf1;border:2px solid var(--green);border-radius:14px}
.trust-title{font-weight:900;color:var(--green-deep);font-size:clamp(1rem,3.5vw,1.15rem)}
.trust-pill{display:inline-block;font-weight:800;font-size:clamp(.9rem,3vw,1rem);background:#fff;color:var(--ink);border:2px solid var(--ink);border-radius:999px;padding:6px 12px}
...
<div class="trust" role="note" aria-label="Parent trust">
  <span class="trust-title">Parents ke liye</span>
  <span class="trust-pill">🛡️ Safe for kids</span>
  <span class="trust-pill">📶 Offline-friendly</span>
  <span class="trust-pill">🔓 Bina login</span>
</div>
<div class="controls">
